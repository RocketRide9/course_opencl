...
kernel void global_matrix_compose(
    // матрица
    volatile global real *d3,
    volatile global real *d2,
    volatile global real *d1,
    volatile global real *d0,
...
)
{
    ...
    atomicAdd_g(&d0[anchor], mat[0][1]);
    atomicAdd_g(&d2[anchor], mat[0][2]);
    atomicAdd_g(&d3[anchor], mat[0][3]);

    atomicAdd_g(&di[anchor + 1], mat[1][1]);
    atomicAdd_g(&d1[anchor + 1], mat[1][2]);
    atomicAdd_g(&d2[anchor + 1], mat[1][3]);

    int a2 = anchor + xn;
    atomicAdd_g(&di[a2], mat[2][2]);
    atomicAdd_g(&d0[a2], mat[2][3]);
