...
//     }
    ...
    public (Real rr, Real pp, int iter) Solve(Slae2 slae, Real[] x)
    {
        ...
        Rsqrt(di_inv);
        // 1.
        MSRMul(_mat, _di, _ia, _ja, x.Length, x, t);
        _b.CopyTo(r, 0);
        Axpy(-1, t, r);
        ...
        for (; iter < _maxIter; iter++)
        {
            ...
            // 2.
            MSRMul(_mat, _di, _ia, _ja, x.Length, y, nu);
            ...
            x.CopyTo(h, 0);
            Axpy(alpha, y, h);
            // BLAS.axpy(_x.Length, alpha, y, h);

            // 5.
            r.CopyTo(s, 0);
            Axpy(-alpha, nu, s);
            // BLAS.axpy(_x.Length, -alpha, nu, s);
            ...
            // 8.
            MSRMul(_mat, _di, _ia, _ja, x.Length, z, t);
            ...
            h.CopyTo(x, 0);
            Axpy(w, z, x);
            // BLAS.axpy(_x.Length, w, z, _x);

            // 11.
            s.CopyTo(r, 0);
            Axpy(-w, t, r);
            // BLAS.axpy(_x.Length, -w, t, r);
            ...
            // 15.
            Axpy(-w, nu, p);
            // BLAS.axpy(_x.Length, -w, nu, p);
            Scale(beta, p);
            // BLAS.scal(_x.Length, beta, p);
            // BLAS.axpy(_x.Length, 1, r, p);
            Axpy(1, r, p);
